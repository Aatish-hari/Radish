# Radish
Redis like in memory data store server implemented in C++. Radish can perform Redis functionality for strings, lists, and hashes, with auto Persistence and multiple client .
...
### Persistence:     
Auto-saves/loads data to redi.db   
### Concurrency:         
